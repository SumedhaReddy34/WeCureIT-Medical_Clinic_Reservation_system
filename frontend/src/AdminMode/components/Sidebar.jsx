...
function Sidebar() {
  ...
  const menuItems = [
    { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/9d47167c648b08011457fb8422c23ccb0faf5e34a75cfbc99d35d21986eda059?placeholderIfAbsent=true&apiKey=8f0d2cc9bf764b679624a1d309a49f82", label: "Dashboard", path: "/admin-dashboard" },
